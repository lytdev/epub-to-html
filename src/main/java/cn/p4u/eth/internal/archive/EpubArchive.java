 ...
 * 本类负责找到条目或读取文本，整本书的打开与关闭由 转换流水线 负责。
 */
public final class EpubArchive {
   ...
   */
  public static String read(ZipFile zip, ZipEntry entry) throws IOException {
   ...
   */
  public static ZipEntry requiredEntry(ZipFile zip, String name) throws IOException {

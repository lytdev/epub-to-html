...
import static cn.p4u.eth.internal.archive.EpubArchive.read;
import static cn.p4u.eth.internal.archive.EpubArchive.requiredEntry;
import static cn.p4u.eth.internal.archive.EpubPaths.normalize;
import static cn.p4u.eth.internal.archive.EpubPaths.resolve;
import static cn.p4u.eth.internal.archive.EpubXml.xml;
...
public final class PackageReader {
   ...
   */
  public static String packagePath(ZipFile zip) throws IOException {
   ...
   */
  public static PackageData readPackage(ZipFile zip, String opfPath) throws IOException {

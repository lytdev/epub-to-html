...
public final class TocTestSupport {
  private TocTestSupport() {}

  /** 汇总片段以便断言全树的标题、正文和资源出现次数。 */
  public static String content(List<TocItem> roots) {
  ...
  public static void assertTreeEquals(List<TocItem> expected, List<TocItem> actual) {
